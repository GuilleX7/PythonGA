...
def launch_second_selection():
    ...
    experiment_distributions(
        ...
        4,
        [
            {"selection_amount": 100, "mutation_probability": 0.01, "halting_generations": 100, "crossover": single_point_crossover},
            # Different crossover
            {"selection_amount": 100, "mutation_probability": 0.01, "halting_generations": 100, "crossover": triple_point_crossover},
            # Different population
            {"selection_amount": 500, "mutation_probability": 0.01, "halting_generations": 100, "crossover": single_point_crossover},
            # Different halting generation number
            {"selection_amount": 100, "mutation_probability": 0.01, "halting_generations": 1000, "crossover": single_point_crossover},
            # Different mutation probability
            {"selection_amount": 100, "mutation_probability": 0, "halting_generations": 100, "crossover": single_point_crossover},
            {"selection_amount": 100, "mutation_probability": 0.2, "halting_generations": 100, "crossover": single_point_crossover}
        ]
    )
